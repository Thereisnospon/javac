...
/**
 * copy form javax.lang.model.element
 */
...
public interface Element {
     ...
     * {@link Elements#getAllAnnotationMirrors(javax.lang.model.element.Element) getAllAnnotationMirrors}.
     *
     * @see ElementFilter
     *
     ...
     *
     * 类型名
     * 构造器"{@code <init>}"，类构造器，"{@code <clinit>}"
     * 其他的可能会返回 empty
     *
    ...
    /**
     *
     * 所有直接嵌套在该 Element 中的 Element,
     * 对于一个类来说，可能是: 成员变量，方法，构造器，内部直接定义的类型。。。
     *
     * 对于一个包来说，可能是: 顶层类/接口，不包括子包中的类？？？
     *
     * 其他类型应当认为没有 EnclosedElements
     *
